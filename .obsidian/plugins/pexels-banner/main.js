  ...
  "src/modal/modals/generateAIBannerModal.js"() {
    ...
    GenerateAIBannerModal = class extends import_obsidian13.Modal {
      ...
      async initializeModal() {
        ...
        const rewritePromptButton2 = promptInspirationContainer.createEl("button", {
        ...
        rewritePromptButton2.addEventListener("click", () => this.rewritePrompt());
      ...
      async rewritePrompt() {
        var _a;
        const rewritePromptButton2 = this.contentEl.querySelector(".pixel-banner-rewrite-button");
        const originalText = rewritePromptButton2.textContent;
        const promptTextarea = this.contentEl.querySelector("#ai-banner-prompt");
        let seed = promptTextarea.value.trim();
        if (seed.length === 0) {
        ...
        try {
          rewritePromptButton2.textContent = "\u23F3";
          rewritePromptButton2.disabled = true;
          ...
          rewritePromptButton2.textContent = originalText;
          rewritePromptButton2.disabled = false;
        }
      }
